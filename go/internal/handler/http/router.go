...
func NewRouter(
	...
	protected.GET("/accounts/:id/subaccounts", accountHandler.listSubAccounts)
	...
	protected.POST("/accounts/:id/subaccounts", accountHandler.createSubAccount)
	protected.PUT("/accounts/:id/subaccounts/:sid", accountHandler.updateSubAccount)
	protected.DELETE("/accounts/:id/subaccounts/:sid", accountHandler.deleteSubAccount)
